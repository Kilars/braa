...
try {
  ...
  await tapVp(360, last.y + 62);
  await page.waitForTimeout(2000);
  console.log("spotlit:", await g("showcase_spotlit"));
  const btns = await g("showcase_buttons");
  // advance to next breed (chocolate)
  await tapVp(btns.next.x, btns.next.y);
  await page.waitForTimeout(2200);
  console.log("spotlit_after_next:", await g("showcase_spotlit"));
  await shot("10-showcase-chocolate");
