// PO pass 37 — probe the breed-showcase dog FRAMING over time: the showcase is the
// "here is my dog, shown off" surface, but it spotlights the LIVE wandering rig. Capture the
// spotlit dog at several moments to see whether the idle-wander walks the dog's face/body out
// of frame (undercutting "shown off").
...
try {
  ...
  await tapVp(70, 32);              // open completion menu
  ...
  await tapVp(last.x, last.y + 62); // open showcase
  await page.waitForTimeout(800);
  // capture the spotlit dog at several moments as the live rig keeps animating
