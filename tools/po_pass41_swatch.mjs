...
try {
  ...
  // focused crop of the «Raser» section — full menu at deviceScaleFactor 3 → 1170x2532 px.
  // Crop generously around the mid-menu where breed rows live; adjust if needed after first look.
  await page.screenshot({ path: `${P}menu-full-hires.png`, clip: { x: 0, y: 0, width: W, height: H } });
