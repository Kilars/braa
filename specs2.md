...
> [CLAUDE.md](https://github.com/Kilars/braa/blob/deprecated-game/.claude/CLAUDE.md) and [tech-decisions.md](tech-decisions.md).
...
> **Constraint (all stories):** stays within mobile WebGL budget (tech-decisions
> §2/§3 — cheap backdrop, blob shadow, no heavy post-processing) and honors
